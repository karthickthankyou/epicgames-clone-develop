  ...
  return (
    <div className='flex items-center justify-center h-screen'>
      <div className='w-full max-w-md'>
        <div className='p-8 mx-auto mt-16 bg-gray-800 rounded shadow-xl'>
          <form
          ...
          >
            ...
            <div className='flex items-baseline justify-between mt-6'>
              ...
              >
                Create{' '}
                {loading && <LoadingIcon className='ml-2 animate-spin' />}
              </button>
            </div>
          </form>
          {error && (
        ...
        <p className='w-full h-full p-2 text-xs text-center text-gray-500'>
          &copy;2021 Karthick Ragavendran. All rights reserved! Except it is
          not.
        </p>
      </div>
    </div>
